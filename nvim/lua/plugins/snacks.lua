 ...
 ░ ░░   ░ ▒░ ░ ░  ░  ░ ▒ ▒░    ░ ░░   ▒ ░░  ░      ░
    ░   ░ ░    ░   ░ ░ ░ ▒       ░░   ▒ ░░      ░
		...
		keys = {
			...
			-- git
			{ "<leader>gB",      function() Snacks.picker.git_branches({ cwd = vim.fn.expand('%:p:h') }) end, desc = "Git Branches" },
			{ "<leader>gl",      function() Snacks.picker.git_log({ cwd = vim.fn.expand('%:p:h') }) end,      desc = "Git Log" },
			{ "<leader>gL",      function() Snacks.picker.git_log_line({ cwd = vim.fn.expand('%:p:h') }) end, desc = "Git Log Line" },
			{ "<leader>gs",      function() Snacks.picker.git_status({ cwd = vim.fn.expand('%:p:h') }) end,   desc = "Git Status" },
			{ "<leader>gS",      function() Snacks.picker.git_stash({ cwd = vim.fn.expand('%:p:h') }) end,    desc = "Git Stash" },
			{ "<leader>gd",      function() Snacks.picker.git_diff({ cwd = vim.fn.expand('%:p:h') }) end,     desc = "Git Diff (Hunks)" },
			{ "<leader>gf",      function() Snacks.picker.git_log_file({ cwd = vim.fn.expand('%:p:h') }) end, desc = "Git Log File" },
			{ "<leader>gb",      function() Snacks.git.blame_line({ cwd = vim.fn.expand('%:p:h') }) end,      desc = "Git Blame Line" },
